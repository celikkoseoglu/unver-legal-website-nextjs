...
import {
  ...
  darkLines,
  colorTransition,
} from "../../stylesheets/components/Animations/UnverLegalLogo.module.sass";

const BlogBrandingLogo = ({ className, isDark }) => (
  <svg className={className} viewBox="0 0 166 55" version="1.1">
    <g>
      <g>
        <g>
          <g>
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M1.9,6.5h9v0.4H7.8v13.5c0,1.1,0.1,2.1,0.3,2.8c0.2,0.7,0.5,1.4,0.9,1.9s0.9,0.8,1.5,1s1.2,0.3,2,0.3
            ...
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M23.2,26.1h3.1V6.9h-3.1V6.5h6l9.5,15.3h0.1V6.9h-3.1V6.5h6.6v0.4h-3.1v19.9h-0.6L26.8,8.1h-0.1v18h3.1v0.4
					h-6.6C23.2,26.5,23.2,26.1,23.2,26.1z"
            />
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M42.5,6.5h8.7v0.4H48l6.2,16.2l6.1-16.2h-3.1V6.5h6v0.4h-2.5l-7.5,20h-0.7L45,6.9h-2.5V6.5z"
            />
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M63.9,26.1H67V6.9h-3.1V6.5h16v4.8h-0.3c-0.2-0.7-0.5-1.4-0.8-1.9c-0.3-0.6-0.6-1-1-1.4
            ...
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M83.6,26.1h3.1V6.9h-3.1V6.5h5.3c0.2,0,0.4,0,0.7,0c0.2,0,0.4,0,0.7,0c0.2,0,0.4,0,0.7,0s0.4,0,0.7,0
      ...
      <g>
        <g>
          <g>
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M64.2,52.1h3.1V32.9h-3.1v-0.4h9v0.4h-3.1v19.2h5c1.6,0,2.9-0.5,3.9-1.5c0.9-1,1.6-2.4,2-4.2h0.3v6.1H64.2
					V52.1z"
            />
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M83.4,52.1h3.1V32.9h-3.1v-0.4h16v4.8h-0.3c-0.2-0.7-0.5-1.4-0.8-1.9s-0.6-1-1-1.4s-0.9-0.7-1.4-0.9
            ...
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M123.9,45.3h-2.2v6.4h-0.3c-0.2-0.2-0.4-0.3-0.5-0.4c-0.1-0.1-0.3-0.1-0.6-0.1c-0.3,0-0.7,0.1-1,0.3
            ...
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M124.5,52.1h2.5l7.6-20h0.7l7.6,20h2.5v0.4h-8.6v-0.4h3.1l-2.9-7.8h-6.5l-2.9,7.8h3.1v0.4h-6v-0.4H124.5z
					 M133.6,35.7l-3.1,8.1h6.2L133.6,35.7z"
            />
            <path
              className={`${isDark ? darkText : lightText} ${colorTransition}`}
              d="M146.1,52.1h3.1V32.9h-3.1v-0.4h9v0.4H152v19.2h5c1.6,0,2.9-0.5,3.9-1.5c0.9-1,1.6-2.4,2-4.2h0.3v6.1h-17.1
    ...
    <g>
      <rect
        x="106.9"
        y="14.9"
        className={isDark ? darkLines : lightLines}
        width="56.3"
        height="2"
      />
    </g>
